                        ...
                        <form role="form" method="post" action="">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Email address" title="Email address" name="email" type="email" autofocus>  </div>                 

                              
                                <!-- Change this to a button or input when using this as a form -->
                                <button class="btn btn-lg btn-success btn-block btn-sm" name="reset" type="submit" title="login"> Reset Password</button>
                                <div class="text-center"><a href="index.php" title="Login">Login</a></div>
                            </fieldset>
                        </form>
                    </div>
                </div>
